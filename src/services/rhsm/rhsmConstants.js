 ...
 *
 * @type {{MEASUREMENTS: string, PRODUCT: string, METRIC_ID: string, COUNT: string}}
 */
 ...
 *     string, PRODUCT: string, METRIC_ID: string, COUNT: string}, RHSM_API_RESPONSE_INSTANCES_DATA_TYPES:
 *     {MEASUREMENTS: string, BILLING_ACCOUNT_ID: string, CATEGORY: string, SUBSCRIPTION_MANAGER_ID: string,
 *     INVENTORY_ID: string, NUMBER_OF_GUESTS: string, BILLING_PROVIDER: string, DISPLAY_NAME: string, CLOUD_PROVIDER:
 *     string, INSTANCE_ID: string, LAST_SEEN: string}, RHSM_API_RESPONSE_SLA_TYPES: {PREMIUM: string, SELF: string,
 *     NONE: string, STANDARD: string}, RHSM_API_RESPONSE_META_TYPES: {PRODUCT: string, COUNT: string},
 *     RHSM_API_RESPONSE_ERRORS_CODE_TYPES: {GENERIC: string, OPTIN: string}, RHSM_API_QUERY_GRANULARITY_TYPES:
 *     {WEEKLY: string, QUARTERLY: string, DAILY: string, MONTHLY: string}, RHSM_API_PATH_PRODUCT_VARIANT_RHEL_TYPES:
 *     {RHEL_ARM: string, RHEL_X86_SAP: string, RHEL_IBM_Z: string, RHEL_IBM_POWER: string, RHEL_X86: string,
 *     RHEL_X86_EUS: string, RHEL_X86_HA: string, RHEL_X86_RS: string}, RHSM_API_RESPONSE_SUBSCRIPTIONS_DATA_TYPES:
