 ...
 *     TRANSFER_GIBIBYTES: string, CORE_SECONDS: string}, RHSM_API_RESPONSE_TALLY_DATA_TYPES: {DATE: string, HAS_DATA: string,
 *     VALUE: string}, RHSM_API_RESPONSE_INSTANCES_META_TYPES: {MEASUREMENTS: string, PRODUCT: string, COUNT: string},
 ...
 *     AWS: string}, RHSM_API_QUERY_BILLING_PROVIDER_TYPES: {RH_MARKETPLACE: string, AZURE: string, AWS: string},
