...
/**
 * ToDo: confirm the behavior described in rhsmSubscriptions func annotation is still accurate
 */
/**
 * Parse RHSM subscriptions response for caching.
 * Attempt to align Instances and Subscriptions responses. The Subscriptions' response "meta" includes the
 * uom/metric_id field if it is included within the query parameters.
 *
 * @param {object} response
 * @returns {object}
 */
