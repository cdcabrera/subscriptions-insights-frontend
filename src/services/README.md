...
| --- | --- | --- |
| func | <code>function</code> | Callback to be executed or cancelled |
...
| --- | --- |
| options | <code>object</code> | 
| options.casing | <code>string</code> | 
| options.convert | <code>boolean</code> | 
| options.id | <code>string</code> | 
| options.response | <code>object</code> \| <code>Array</code> | 
| options.schema | <code>\*</code> | 
...
| config.cache | <code>object</code> | 
| config.cancel | <code>boolean</code> | 
| config.cancelId | <code>string</code> | 
| config.params | <code>object</code> | 
| config.schema | <code>Array</code> | 
| config.transform | <code>Array</code> | 
| config.url | <code>string</code> \| <code>function</code> | 
| options | <code>object</code> | 
| options.cancelledMessage | <code>string</code> | 
| options.responseCache | <code>object</code> | 
| options.xhrTimeout | <code>number</code> | 
...
* [PlatformServices](#Platform.module_PlatformServices)
    ...
    * [~initializeChrome()](#Platform.module_PlatformServices..initializeChrome) ⇒ <code>Promise.&lt;\*&gt;</code>
    * [~onNavigation(callback)](#Platform.module_PlatformServices..onNavigation) ⇒ <code>function</code>
    * [~setAppName(name)](#Platform.module_PlatformServices..setAppName) ⇒ <code>Promise.&lt;\*&gt;</code>
    * [~setAppNav(id, options)](#Platform.module_PlatformServices..setAppNav) ⇒ <code>Promise.&lt;\*&gt;</code>
...
| Param | Type | Default |
| --- | --- | --- |
| isHidden | <code>boolean</code> | <code>true</code> | 

<a name="Platform.module_PlatformServices..initializeChrome"></a>

### PlatformServices~initializeChrome() ⇒ <code>Promise.&lt;\*&gt;</code>
...
<a name="Platform.module_PlatformServices..setAppName"></a>

### PlatformServices~setAppName(name) ⇒ <code>Promise.&lt;\*&gt;</code>
Set application ID.
...
<a name="Platform.module_PlatformServices..setAppNav"></a>

### PlatformServices~setAppNav(id, options) ⇒ <code>Promise.&lt;\*&gt;</code>
...
| Param | Type | Description |
| --- | --- | --- |
| id | <code>string</code> | The navigation ID associated with internal route config, and external platform nav config |
| options | <code>object</code> |  |
...
| response | <code>object</code> |  |
| options | <code>object</code> |  |
| options.config | <code>object</code> | Pass in a configuration object, RBAC |
...
| --- | --- |
| options | <code>object</code> | 
| options.cancel | <code>boolean</code> | 
...
| params | <code>object</code> | Query/search params |
| options | <code>object</code> |  |
| options.cancel | <code>boolean</code> |  |
| options.cancelId | <code>string</code> |  |
...
| Param | Type | Description |
| --- | --- | --- |
| id | <code>string</code> \| <code>Array</code> | String ID, or an array of identifiers to update a dotenv url path |
| params | <code>object</code> | Query/search params |
| options | <code>object</code> |  |
| options.cancel | <code>boolean</code> |  |
| options.cancelId | <code>string</code> |  |
...
| Param | Type | Description |
| --- | --- | --- |
| id | <code>string</code> | Subscription Manager ID |
| params | <code>object</code> | Query/search params |
| options | <code>object</code> |  |
| options.cache | <code>boolean</code> |  |
| options.cancel | <code>boolean</code> |  |
| options.cancelId | <code>string</code> |  |
| options.schema | <code>Array</code> | An array of callbacks used to transform the response, ie. [SUCCESS SCHEMA, ERROR SCHEMA] |
| options.transform | <code>Array</code> | An array of callbacks used to transform the response, ie. [SUCCESS TRANSFORM, ERROR TRANSFORM] |
...
| response | <code>object</code> | 
| config | <code>object</code> | 
| config._isCapacity | <code>boolean</code> | 
| config.params | <code>string</code> | 
...
| Rhsm | <code>module</code> | 
| User | <code>module</code> | 
