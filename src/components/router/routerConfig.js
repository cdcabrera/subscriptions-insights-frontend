...
const routes = [
  ...
  },
  {
    ...
    to: '/openshift-sw/openshift-dedicated',
...
const navigation = [
  ...
  },
  {
    ...
    productParameter: RHSM_API_PATH_ID_TYPES.OPENSHIFT_DEDICATED_METRIC,
    viewParameter: `view${RHSM_API_PATH_ID_TYPES.OPENSHIFT_DEDICATED_METRIC}`
  },
  {
    id: 'satellite-sw',
