...
ProductViewOpenShiftDedicated.defaultProps = {
  productConfig: {
    ...
    graphTallyQuery: {
      ...
      [RHSM_API_QUERY_TYPES.START_DATE]: dateHelpers.getRangedMonthDateTime('current').startDate.toISOString(),
      [RHSM_API_QUERY_TYPES.END_DATE]: dateHelpers.getRangedMonthDateTime('current').endDate.toISOString()
    },
    inventoryHostsQuery: {
