...
const ToolbarFieldBillingProvider = ({
  ...
  return (
    <Select
      aria-label={t('curiosity-toolbar.placeholder', { context: [isFilter && '_filter', 'billing_provider'] })}
      onSelect={onSelect}
      options={updatedOptions}
      selectedOptions={updatedValue}
      placeholder={t('curiosity-toolbar.placeholder', { context: [isFilter && '_filter', 'billing_provider'] })}
      position={position}
