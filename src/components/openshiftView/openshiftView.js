      ...
      <PageLayout>
        ...
        <PageSection>
          <GraphCard
            ...
            productId={productId}
            viewId={viewId}
            cardTitle={t('curiosity-graph.cardHeading', { context: `${productId}_${uomFilter}` })}
...
OpenshiftView.defaultProps = {
  ...
  graphTallyQuery: {
    ...
    [RHSM_API_QUERY_TYPES.START_DATE]: dateHelpers.getRangedDateTime(GRANULARITY_TYPES.DAILY).startDate,
    [RHSM_API_QUERY_TYPES.END_DATE]: dateHelpers.getRangedDateTime(GRANULARITY_TYPES.DAILY).endDate
  },
  inventoryHostsQuery: {
