 ...
 * @param {Array<number>} [props.keyCode] Key code defaults to "debug"
 * @param {string|Error} [props.message]
 * @param {string} [props.title]
 * @param {translate} [props.t=translate]
 * @returns {JSX.Element}
 */
const ErrorMessage = ({ description, keyCode = [68, 69, 66, 85, 71], message, title, t = translate }) => {
