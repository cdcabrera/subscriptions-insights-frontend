 ...
 *
 * @type {{QUANTITY: string, USAGE: string, NEXT_EVENT_TYPE: string, NEXT_EVENT_DATE: string, SLA: string, SKU: string}}
 */
 ...
 *     NEXT_EVENT_DATE: string, SLA: string, SKU: string}, RHSM_API_RESPONSE_META_TYPES: {COUNT: string,
