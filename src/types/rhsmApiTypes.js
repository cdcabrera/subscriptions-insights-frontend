 ...
 *     QUANTITY: string, NEXT_EVENT_TYPE: string, NEXT_EVENT: string, VIRTUAL_CAPACITY: string,
 ...
 *
 * @type {{QUANTITY: string, USAGE: string, NEXT_EVENT_TYPE: string, NEXT_EVENT: string, SLA: string, SKU: string}}
 */
 ...
 *     NEXT_EVENT: string, VIRTUAL_CAPACITY: string, TOTAL_CAPACITY: string, SKU: string, PRODUCT_NAME: string,
 ...
 *     NEXT_EVENT: string, SLA: string, SKU: string}, RHSM_API_RESPONSE_META_TYPES: {COUNT: string,
