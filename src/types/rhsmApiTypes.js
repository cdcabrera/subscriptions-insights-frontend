...
const RHSM_API_RESPONSE_TALLY_META_TOTAL_MONTHLY_TYPES = {
  DATE: 'date',
  VALUE: 'value'
};
 ...
 *     TOTAL_INSTANCE_HOURS: string, TOTAL_CORE_HOURS: string}, RHSM_API_RESPONSE_TALLY_META_TOTAL_MONTHLY_TYPES: {DATE: string,
 *     VALUE: string}, RHSM_API_QUERY_GRANULARITY_TYPES: {WEEKLY: string, QUARTERLY: string, DAILY: string, MONTHLY: string},
 ...
 *     CONDUIT_SYNC: string}, RHSM_API_RESPONSE_LINKS: string, RHSM_API_PATH_METRIC_ID_TYPES: {CORES: string,
 ...
 *     RHEL_IBM_POWER: string}, RHSM_API_QUERY_SET_OPTIN_TYPES: {TALLY_SYNC: string, TALLY_REPORT: string,
 ...
 *     SLA: string, LIMIT: string}, RHSM_API_RESPONSE_TALLY_META_TYPES: {TOTAL_MONTHLY: string, HAS_CLOUDIGRADE_DATA: string,
 *     HAS_CLOUDIGRADE_MISMATCH: string, METRIC_ID: string, COUNT: string}, RHSM_API_QUERY_SORT_TYPES: {CORES: string,
...
const rhsmApiTypes = {
  ...
  RHSM_API_RESPONSE_TALLY_META_TOTAL_MONTHLY_TYPES,
