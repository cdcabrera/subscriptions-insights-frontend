...
const GET_GRAPH_TALLY_CAPACITY_RHSM = 'GET_GRAPH_TALLY_CAPACITY_RHSM';
 ...
 *     GET_SUBSCRIPTIONS_INVENTORY_RHSM: string, GET_HOSTS_INVENTORY_RHSM: string, GET_GRAPH_TALLY_CAPACITY_RHSM: string}}
 */
const rhsmTypes = {
  GET_GRAPH_REPORT_CAPACITY_RHSM,
  GET_GRAPH_TALLY_CAPACITY_RHSM,
