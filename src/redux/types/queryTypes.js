 ...
 *     SET_QUERY_RHSM_GUESTS_INVENTORY_TYPES: string, SET_QUERY_CLEAR: string, SET_QUERY_CLEAR_INVENTORY_LIST: string,
 *     SET_QUERY_RHSM_HOSTS_INVENTORY_TYPES: string, SET_QUERY: string, SET_QUERY_RESET_INVENTORY_LIST: string,
