...
const PLATFORM_BUNDLE_DATA = 'PLATFORM_BUNDLE_DATA';
 ...
 *     PLATFORM_BUNDLE_DATA: string, PLATFORM_ADD_NOTIFICATION: string, PLATFORM_REMOVE_NOTIFICATION: string,
 *     PLATFORM_ON_NAV: string}}
 */
const platformTypes = {
  PLATFORM_ADD_NOTIFICATION,
  PLATFORM_REMOVE_NOTIFICATION,
  PLATFORM_CLEAR_NOTIFICATIONS,
  PLATFORM_BUNDLE_DATA,
