 ...
 *     PLATFORM_CLEAR_NOTIFICATIONS: string, UPDATE_PLATFORM_EXPORT_POLL: string, PLATFORM_ADD_NOTIFICATION: string,
 *     PLATFORM_REMOVE_NOTIFICATION: string, GET_PLATFORM_EXPORT: string}}
 */
const platformTypes = {
  ...
  UPDATE_PLATFORM_EXPORT_POLL: 'UPDATE_PLATFORM_EXPORT_STATUS'
};
